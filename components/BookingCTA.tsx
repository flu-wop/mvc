...
const perks = [
  {
    icon: Calendar,
    text: "Flexible scheduling — weekends available",
  },
  {
    icon: Clock,
    text: "House calls & pop-ups across Greater NOLA",
  },
  {
    icon: MapPin,
...
export default function BookingCTA() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #0A3D33 0%, #0C0C0C 50%, #1a0a1a 100%)",
      }}
    >
      {/* Decorative orbs */}
      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8 text-center relative z-10">
        ...
        <motion.div
          ...
          className="relative"
        >
          {/* Placeholder container where Acuity embed will live */}
          <div className="rounded-2xl border border-white/10 bg-white/3 backdrop-blur-sm p-10 md:p-14 mb-6">
            <div className="flex flex-col items-center gap-3 mb-8">
              ...
              <p className="text-white/40 text-sm">
                Acuity Scheduling embed loads here
              </p>
            </div>

            {/* Primary CTA — links to live Acuity scheduler */}
            <a
