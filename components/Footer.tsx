      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-16 md:py-20">
        ...
        >
          ...
          <div className="md:col-span-2">
            ...
            >
              Luxury custom press-on nails handcrafted with Honduran artistry and
              New Orleans soul. Every set is wearable art.
            </p>
        ...
        >
          ...
          <div className="relative rounded-2xl overflow-hidden border border-white/8 shadow-[0_0_40px_rgba(255,20,147,0.05)]">
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110954.86865498522!2d-90.13864599999999!3d29.95107!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8620a4b6b0f2f4e7%3A0xbae1d0a0e7a2c67f!2sNew%20Orleans%2C%20LA!5e0!3m2!1sen!2sus!4v1715000000000"
              // TODO: If MVC Creations ever gets a fixed studio address, replace the embed URL above
              // with one centered on that address. Generate a new embed URL at:
              // https://maps.google.com → share → embed a map → copy iframe src.
              width="100%"
              height="320"
              ...
              title="MVC Creations service area — Greater New Orleans, LA"
            />
          </div>
          ...
          <p className="text-white/35 text-xs mt-3 flex items-center gap-1.5">
            ...
            House calls & pop-ups across Greater New Orleans, LA
          </p>
        </motion.div>
