      ...
      <div className="max-w-6xl mx-auto px-5 md:px-8 py-16">
        ...
        >
          ...
          <div>
            ...
            <p className="text-cream/45 text-sm leading-relaxed mt-4 mb-5 max-w-xs">
              ...
              {socials.map((s) => {
                ...
                return (
                  <a
                    ...
                    aria-label={s.label}
                    className="w-9 h-9 rounded-full bg-white/5 border border-border flex items-center justify-center text-cream/50 hover:text-gold hover:border-gold/40 transition-all duration-200"
                  >
          ...
          {/* Hours */}
          <div>
            <p className="text-cream text-xs font-semibold tracking-[0.15em] uppercase mb-4">
              Business Hours
            </p>
            <p className="text-cream/60 text-sm">9:00 AM – 6:00 PM</p>
            <p className="text-cream/60 text-sm mb-2">Monday – Saturday</p>
            <p className="text-cream/40 text-sm">Closed Sunday</p>
          </div>
