...
export default function Policies() {
  ...
  return (
    <section id="policies" ref={ref} className="py-24 md:py-32 bg-[#0A0A0A] relative">
      ...
      <div className="max-w-5xl mx-auto px-5 md:px-8">
        ...
        >
          ...
          >
            Booking <span className="text-[#FF1493] italic">Policies</span>
          </h2>
        </motion.div>
        ...
        >
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{ background: `${policy.accent}20`, border: `1px solid ${policy.accent}30` }}
                  >
          ...
          <div className="sm:col-span-2 rounded-2xl border border-white/5 overflow-hidden bg-white/[0.02]">
            <button
