  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-8 pt-28 pb-20 text-center">
        ...
        >
          <span>✦</span>
          <span>Licensed Nail Artist · Kenner, LA</span>
          <span>✦</span>
        </motion.div>
        ...
        >
          {[
            { text: "MVC", className: "block text-white" },
            { text: "Creations", className: "block text-gold-shimmer italic" },
            {
              text: "Nails, made",
              className:
                "block text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-normal mt-1",
            },
            {
              text: "personal.",
              className:
                "block text-[#FF1493] text-3xl sm:text-4xl md:text-5xl font-normal italic mt-1",
            },
          ].map((line, i) => (
            <motion.span
              key={line.text}
        ...
        >
          Acrylics, gel-X, natural nail care & press-ons with Margie.
          <br className="hidden sm:block" /> Based in Kenner, near MSY.
        </motion.p>
