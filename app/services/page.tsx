// TODO: Build out the full /services page with pricing, booking per service, and Acuity links
...
export default function ServicesPage() {
  return (
    <main className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center text-white px-6 text-center">
      ...
      <h1 className="text-5xl font-bold mb-4" style={{ fontFamily: "var(--font-playfair)" }}>Services</h1>
